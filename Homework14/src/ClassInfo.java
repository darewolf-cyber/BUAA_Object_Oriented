...
public class ClassInfo {
    ...
    private final HashSet<String> assNames = new HashSet<>();
    ...
    public boolean hasAssName(String name) {
        return assNames.contains(name);
    }
    ...
    void addInterface(String interfaceId, String interfaceName) {
    ...
    void addAssociation(String assName, String classId, boolean isClass) {
        if (isClass) {
            assSet.add(classId);
        }
        if (assName != null) {
